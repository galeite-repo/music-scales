      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gradient-to-br from-slate-800/60 to-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white hover:bg-slate-100 text-slate-900 font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
          ...
          <p className="mt-6 text-center text-slate-400 text-sm">
            Ao fazer login, suas escalas serão privadas e acessíveis apenas para você.
          </p>
        </div>

        {/* Footer */}
        <p className="text-center text-slate-500 text-xs mt-8">
          Suas escalas são armazenadas com segurança no Supabase
        </p>
      </div>
    </div>
  );
